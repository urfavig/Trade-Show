...
class EventRegistrationGUI:
    def __init__(self, master):
        self.master = master
        master.title("Speaker Registration")
        ...
        self.register_button = tk.Button(master, text="Register", command=self.register_speaker)
    ...
    def register_speaker(self):
        ...
        registration_result = self.event_registration.register_speaker(name, topic, email, contact_number)
