...
class EventRegistrationGUI:
    def __init__(self, master):
        self.master = master
        master.title("Observer Registration")
        ...
        self.register_button = tk.Button(master, text="Register", command=self.register_observer)
    ...
    def register_observer(self):
        ...
        registration_result = self.event_registration.register_observer(name, topic, email, contact_number)
...
if __name__ == "__main__":
    root = tk.Tk()
    event_registration_gui = EventRegistrationGUI(root)
